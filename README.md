...
<div style='font-size:13px;opacity:0.92;'>Lineage heat: 2 outbound / 1 inbound · ✅ No engine drift detected · Index coverage: todo · PII: none · Changelog: fresh (2 d)</div>
</div>
...
- Pkg folder: [packages\carts](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\carts)
...
graph LR
  ...
  carts["carts"]:::center
  carts -->|FK| tenants["tenants"]:::link
  carts -->|FK| users["users"]:::accent
  cart_items["cart_items"]:::inbound -->|FK| carts
...
| Inbound links (tables depending on this) | 1 |
| Views | 6 |
| Seeds | 0 |
| Drift warnings | 0 |
| PII flags | 0 |
...
- Inbound (relies on this): "cart_items"
...
## Compliance Notes
_No PII-like columns detected in definitions.md._

## Usage
- Install/upgrade schema: pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package carts -Apply
