...
> Lineage: 2 outbound / 1 inbound · ✅ No engine drift detected · Index coverage: todo · PII flags: 0 · Changelog: fresh (2 d)
...
| Pkg folder | [packages\carts](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\carts) | Repo location |
...
pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package carts -Apply
