...
final class Criteria extends BaseCriteria
{
    ...
    {
        return [ 'id', 'tenant_id', 'user_id', 'note', 'created_at', 'updated_at', 'version' ];
    }
    ...
    {
        $x = [ 'id', 'tenant_id', 'user_id', 'note', 'created_at', 'updated_at', 'version' ];
    ...
    public static function fromDb(
        ...
        if (\method_exists(\BlackCat\Database\Packages\Carts\Definitions::class, 'softDeleteColumn')) {
            $soft = \BlackCat\Database\Packages\Carts\Definitions::softDeleteColumn();
