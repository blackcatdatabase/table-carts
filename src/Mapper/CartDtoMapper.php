...
final class CartDtoMapper
{
    ...
    private const COL_TO_PROP = [ 'user_id' => 'userId', 'created_at' => 'createdAt', 'updated_at' => 'updatedAt' ];
    /** @var string[] */
    private const BOOL_COLS   = [];
    /** @var string[] */
    private const INT_COLS    = [ 'user_id' ];
    /** @var string[] */
    ...
    /** @var string[] */
    private const NULLABLE    = [ 'id', 'user_id' ];
