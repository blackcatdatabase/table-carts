...
namespace BlackCat\Database\Packages\Carts\Mapper;

use BlackCat\Database\Packages\Carts\Dto\CartDto;
use BlackCat\Database\Packages\Carts\Definitions;
use DateTimeZone;
use BlackCat\Database\Support\DtoHydrator;

/**
 * Bidirectional mapper between DB rows and DTO CartDto:
 ...
 */
final class CartDtoMapper
{
    /** @var array<string,string> Column -> DTO property */
    private const COL_TO_PROP = [ 'id' => 'id', 'tenant_id' => 'tenantId', 'user_id' => 'userId', 'note' => 'note', 'created_at' => 'createdAt', 'updated_at' => 'updatedAt', 'version' => 'version' ];

    /** @var string[] */
    private const BOOL_COLS   = [];
    /** @var string[] */
    private const INT_COLS    = [ 'tenant_id', 'user_id', 'version' ];
    /** @var string[] */
     ...
     * @return CartDto
     */
    public static function fromRow(array $row): CartDto
    {
        /** @var CartDto */
    ...
    public static function fromRowOrNull(?array $row): ?CartDto
    {
     ...
     */
    public static function toRow(CartDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(CartDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(CartDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(CartDto $dto): array
    {
        $row = self::toRow($dto);
