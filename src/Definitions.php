...
final class Definitions {
    ...
    /** @return string[] */
    public static function columns(): array { return [ 'id', 'user_id', 'note', 'created_at', 'updated_at', 'version' ]; }
    ...
    public static function intColumns(): array { return [ 'user_id', 'version' ]; }
