...
final class Definitions {
    // --- core metadata ---
    public static function table(): string { return 'carts'; }
    public static function contractView(): string { return 'vw_carts'; }
    /** @return string[] */
    public static function columns(): array { return [ 'id', 'tenant_id', 'user_id', 'note', 'created_at', 'updated_at', 'version' ]; }
    ...
    public static function intColumns(): array { return [ 'tenant_id', 'user_id', 'version' ]; }
