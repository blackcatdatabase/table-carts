...
use BlackCat\Database\Packages\Carts\Repository\CartRepository;
...
final class Repository
{
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\Carts\Dto\CartDto|null
    {
        return $this->repo->getByUnique($keys, $asDto);
    }

    /** @return array<string,mixed>|\BlackCat\Database\Packages\Carts\Dto\CartDto|null */
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\Carts\Dto\CartDto|null
    {
