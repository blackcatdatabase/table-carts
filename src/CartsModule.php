...
final class CartsModule implements ModuleInterface
{
    public function name(): string { return 'table-carts'; }
    ...
    public static function contractView(): string { return 'vw_carts'; }
...
SQL;
    ...
    public function status(Database $db, SqlDialect $d): array
    {
        ...
        $expectedIdx = [ 'idx_carts_tenant', 'ux_carts_tenant_id' ];
        if ($d->isMysql()) {
        ...
        $expectedFk  = [ 'fk_carts_tenant', 'fk_carts_user' ];
    ...
    public function info(): array
    {
        return [
            ...
            'indexes'     => [ 'idx_carts_tenant', 'ux_carts_tenant_id' ],
            'foreignKeys' => [ 'fk_carts_tenant', 'fk_carts_user' ],
        ];
    }
}
